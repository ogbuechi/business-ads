...
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    this.chat(); // this.$nextTick(function () {
    //     window.setInterval(() => {
    //         this.chat();
    //     },5000);
    // })
  ...
  methods: {
    chat: function chat() {
      ...
      axios.get("/chat/conversation/".concat(this.user.id)).then(function (response) {
    ...
    send: function send(e) {
      ...
      axios.post('/chat/conversation/send', {
        ...
        _this2.messages.push(response.data); // console.log(this.contact.id);
...
var render = function() {
  ...
  return _c("div", { staticClass: "chat_window" }, [
    _c("div", { staticClass: "top_menu" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "title" }, [_vm._v(_vm._s(_vm.user.name))])
    ]),
    _vm._v(" "),
    _vm.user
      ? _c(
          "ul",
          { ref: "feed", staticClass: "messages feed" },
          _vm._l(_vm.messages, function(message) {
            return _c(
              "li",
              {
                ...
                class:
                  "message" +
                  (message.receiver_id == _vm.user.id
                    ? " right appeared"
                    : " left appeared")
              },
              [
...
__webpack_require__(/*! /opt/lampp/htdocs/business_ads/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /opt/lampp/htdocs/business_ads/resources/sass/app.scss */"./resources/sass/app.scss");
