            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper">
                        <h2 class="product-title">Open Partnerships Listings</h2>
                        <ol class="breadcrumb">
                            <li><a href="{{ route('home') }}">Home /</a></li>
                            <li class="current">Open Partnerships Listings</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 page-content">
                        <div class="adds-wrapper jumbotron text-center">
                            <div class="tab-content">
                                <h3>No Open Partnerships Ads Available</h3>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="col-lg-9 col-md-12 col-xs-12 page-content">
                        ...
                        <div class="product-filter">
                            <div class="short-name">
                                <span>Showing (1 - {{ count($invests) }} Open Partnerships of {{ $count }} Open Partnerships Ads)</span>
                            </div>
