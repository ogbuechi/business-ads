...
<header id="top-nav" class="top-nav page-header">
    <div class="container"><a href="#" class="logo smooth-scroll">
            <img src="img/mark.png" alt="logo" class="logo-white"><img src="img/mark.png" alt="logo" class="logo-dark"></a>
        <nav class="top-menu">
            <ul class="sf-menu">
                <!--Menu default-->
                ...
                <li><a href="admin/index2.html">Features</a>
                ...
                <li><a href="affiliates.html">Affiliates</a>

                </li>
                <li><a href="admin/login.html">Sign in</a></li>
                <li><a href="admin/register.html" class="btn dark-btn large-btn" id="butn">Try Free Today</a></li>
...
<!--<div class="content-nav table-cell">-->
<!--<h3>Fact about us:</h3>-->
<!--<p>Start your Amazon to eBay dropshipping business - in minutes.</p>-->
<!--</div>-->
<!--</div>-->
<!--</div>-->
<!--</div>-->
            ...
            <div class="container-slide vertical-align center head-desc">
                <div class="container">
                    <div class="row" id="designs">
                        <div class="col-md-12">
                            <div class="heading-title-big">Best <span>For Business Planning</span></div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-push-2">
                <div class="heading-title center">
                    ...
                    <div class="small-desd">Steps to  <span>a successful Business Planning</span></div>
                    <p>Use the following steps to create a perfect account</p>
                </div>
            </div>
        </div>
